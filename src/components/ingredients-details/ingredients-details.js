  ...
  return (
    <div className={styles.container}>
      ...
      <ul className={styles.list}>
        <li><p className='text text_type_main-default pb-1'>Калории, ккал</p><p className={`text text_type_digits-default ${styles.digits}`}>
            {item.calories}
          </p>
        </li>
        <li><p className='text text_type_main-default pb-1'>Белки, г</p><p className={`text text_type_digits-default ${styles.digits}`}>
            {item.proteins}
          </p>
        </li>
        <li><p className='text text_type_main-default pb-1'>Жиры, г</p><p className={`text text_type_digits-default ${styles.digits}`}>
            {item.fat}
          </p>
        </li>
        <li>
